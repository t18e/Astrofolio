...
summary: "On social media & performance fatigue."
tags: "Digital, Technology, Metalinguistics"
---
...
The technology isn't quite there, but it's not hard to see how [Unreal Engine's Creator](https://www.unrealengine.com/en-US/metahuman) and [NVIDIA's ACE](https://blogs.nvidia.com/blog/omniverse-ace-early-access/) could be integrated with social platforms to let our digital twins post content while we're busy making more content. What happens in a world where we’re capable of creating — and engaging — on a 10x or 100x scale?

It seems we're further participating in a digital landscape where the gap between authentic human interaction — and connection — and engagement-driven performances is rapidly closing.
...
\[2\] [Kai Cenat](https://www.twitch.tv/kaicenat) is perhaps the best example of this. Interestingly, I find his content quite refreshing given how authentic it seems.
